...
mc = ModelCheckpoint('core_model_inceptionv3_check_point.keras', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
...
assist_obj.get_model_performance_plot(trained_model)
...
model_path = assist_obj.save_the_trained_model(model,accuracy,fine_tune_at)
